...
function(export_library exp_target)
    ...
    if(NOT TARGET "${pkg_target}")
        message(FATAL_ERROR "Cannot export library into non-existent package '${ARG_PACKAGE}' (Check the PACKAGE argument)")
    endif()
        ...
        if(TARGET "${lib}" AND NOT is_imported)
            if(NOT lib IN_LIST already_exported)
                message(WARNING
                    ...
                    "is not export_library(${lib}) call, THE GENERATED EXPORT WILL "
                    "BE INCORRECT!"
                    )
            endif()
